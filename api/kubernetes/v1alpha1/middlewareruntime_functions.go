...
func (r *MiddlewareRuntime) GetEntrypoints() []MiddlewareEntrypoint {
	var entrypoints []MiddlewareEntrypoint
	...
	for _, middleware := range r.GetMiddlewares() {
		...
		entrypoints = append(entrypoints, *middleware.Entrypoint)
	}
...
func (r *MiddlewareRuntime) GetRuntimeType() RuntimeType {
	return RuntimeTypeMiddlewareRuntime
}
...
func (r *MiddlewareRuntime) GetMiddlewares() []Middleware {
	...
	middlewares = append(middlewares, r.Spec.Caches...)
...
// GetUniqueID returns a unique identifier for the Middleware.
// The unique identifier is generated by concatenating the Middleware's type, name, and space.
