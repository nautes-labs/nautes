...
//+kubebuilder:rbac:groups=nautes.resource.nautes.io,resources=middlewareruntimes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=nautes.resource.nautes.io,resources=middlewareruntimes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=nautes.resource.nautes.io,resources=middlewareruntimes/finalizers,verbs=update
