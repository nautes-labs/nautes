...
- Following the best practices of GitOps, with the version repository as the single trusted data source. When data in the repository changes, the Operator automatically detects the changes and performs incremental updates to the Kubernetes cluster. 
